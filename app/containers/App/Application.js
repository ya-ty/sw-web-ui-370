...
import {
  AnalyticDashboard, MarketingDashboard, CryptoDashboard, HeatmapDashboard,
  ...
  D3BarCharts, D3PieCharts, D3StackedBarCharts,
  D3SunburstCharts
} from '../pageListAsync';
...
class Application extends React.Component {
  render() {
    const {
      changeMode, history, isAuthenticated, loggingIn
    } = this.props;
    ...
    return (
      <Dashboard history={history} changeMode={changeMode}>
        <Switch>
          ...
          <Route path="/app/heatmap-dashboard" component={HeatmapDashboard} />
          { /* Widgets */ }
          ...
          { /* D3 Chart */ }
          <Route path="/app/d3-charts/d3-bar-charts" component={D3BarCharts} />
          <Route path="/app/d3-charts/d3-pie-charts" component={D3PieCharts} />
          <Route path="/app/d3-charts/d3-stacked-charts" component={D3StackedBarCharts} />
          <Route path="/app/d3-charts/d3-sunburst-charts" component={D3SunburstCharts} />
          { /* Sample Apps */ }
