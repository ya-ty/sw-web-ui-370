...
describe('<Modal />', () => {
  ...
  describe('two modal at the same time', () => {
    ...
    it('should open and close with Transitions', done => {
      const TestCase = ({ open, onEntered, onExited }) => (
        <React.Fragment>
          <Modal open={open}>
            <Fade onEntered={onEntered} onExited={onExited} in={open}>
              <div>Hello</div>
            </Fade>
          </Modal>
          <Modal open={open}>
  ...
  describe('prop: closeAfterTransition', () => {
    it('when true it should close after Transition has finished', done => {
      const TestCase = ({
        open, onEntered, onExiting, onExited
      }) => (
    ...
    it('when false it should close before Transition has finished', done => {
      const TestCase = ({
        ...
        <Modal open={open} closeAfterTransition={false}>
          <Fade
            onEntered={onEntered}
            onExiting={onExiting}
            onExited={onExited}
