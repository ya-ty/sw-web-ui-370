...
export const HeatmapDashboard = Loadable({
  loader: () => import('./Dashboard/HeatmapDashboard'),
  loading: Loading,
});
...
// D3 Chart
export const D3BarCharts = Loadable({
  loader: () => import('./D3Charts/D3BarCharts'),
  loading: Loading,
});
export const D3PieCharts = Loadable({
  loader: () => import('./D3Charts/D3PieCharts'),
  loading: Loading,
});
export const D3StackedBarCharts = Loadable({
  loader: () => import('./D3Charts/D3StackedBarCharts'),
  loading: Loading,
});
export const D3SunburstCharts = Loadable({
  loader: () => import('./D3Charts/D3SunburstCharts'),
  loading: Loading,
});
// Pages
