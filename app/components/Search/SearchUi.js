...
function getSuggestions(value) {
  ...
  let count = 0;
  return inputLength === 0 ? [] : menuItems.filter(suggestion => {
...
class SearchUi extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (prevProps.menu.length !== menu.length) {
      this.updateMenuItems();
    }
  }
...
export default connect(mapStateToProps, null)(withStyles(styles)(injectIntl(SearchUi)));
