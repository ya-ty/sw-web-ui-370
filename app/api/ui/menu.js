  ...
  },
  {
    ...
    child: [
      ...
      },
      {
        ...
        name: 'D3 Bar',
        icon: 'bar_chart',
        link: '/app/d3-charts/d3-bar-charts'
      },
      {
        key: 'd3_pie_charts',
        name: 'D3 Pie',
        icon: 'pie_chart',
        link: '/app/d3-charts/d3-pie-charts'
      },
      {
        key: 'd3_stacked_charts',
        name: 'D3 Stacked Bar',
        icon: 'insert_chart',
        link: '/app/d3-charts/d3-stacked-charts'
      },
      {
        key: 'd3_sunburst_charts',
        name: 'D3 Sunburst',
        icon: 'donut_small',
        link: '/app/d3-charts/d3-sunburst-charts'
      },
      {
        key: 'svg_charts',
        name: 'SVG Chart',
